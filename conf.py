...
"""
ansicolortags documentation build configuration file, created by sphinx-quickstart on Thu Mar 14 10:27:52 2013.
...
project = u'ansicolortags documentation'
copyright = u'2016, Lilian Besson'
...
googleanalytics_id = 'UA-38514290-8'
...
htmlhelp_basename = 'ansicolortagsdoc'
...
latex_documents = [
    ('index', 'ansicolortags.tex', u'ansicolortags Documentation',
...
texinfo_documents = [
    ('index', 'ansicolortags', u'ansicolortags Documentation',
     u'Lilian Besson', 'ansicolortags', 'One line description of project.',
     'Miscellaneous'),
]
